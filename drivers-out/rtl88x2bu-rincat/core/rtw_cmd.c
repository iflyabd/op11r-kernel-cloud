...
static u8 session_tracker_cmd(_adapter *adapter, u8 cmd, struct sta_info *sta,
...
static __maybe_unused void rtw_getrttbl_cmd_cmdrsp_callback(
	_adapter *padapter, struct cmd_obj *pcmd)
{
