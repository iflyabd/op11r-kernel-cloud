...
static void backup_bb_register(struct dm_struct *dm, u32 *bb_backup,
	u32 *backup_bb_reg, u32 counter)
{
	u32 i ;
...
static void restore_bb_register(struct dm_struct *dm, u32 *bb_backup,
	u32 *backup_bb_reg, u32 counter)
{
	u32 i ;
