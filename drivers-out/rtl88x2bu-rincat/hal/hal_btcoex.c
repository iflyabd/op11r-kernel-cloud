...
static void halbtcoutsrc_WriteLIndirectReg(void *pBtcContext, u16 reg_addr,
...
static void halbtcoutsrc_SetRfReg(void *pBtcContext, enum rf_path eRFPath,
...
static void halbtcoutsrc_phydm_modify_RA_PCR_threshold(void *pBtcContext,
...
static __maybe_unused void EXhalbtcoutsrc_dbg_control(PBTC_COEXIST pBtCoexist,
	u8 opCode, u8 opLen, u8 *pData)
{
	if (!halbtcoutsrc_IsBtCoexistAvailable(pBtCoexist))
		return;
